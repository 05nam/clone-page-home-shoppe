                        ...
                        <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel" style={{ paddingRight: '5px' }}>
                            ...
                            <div className="carousel-inner">
                                <div className="carousel-item active">
                                    <img src="./img/slider/bn-02.jpg" className="d-block w-100" alt="..." />
                                </div>
                                <div className="carousel-item">
                                    <img src="./img/slider/bn-09.jpg" className="d-block w-100" alt="..." />
                                </div>
                                <div className="carousel-item">
                                    <img src="./img/slider/bn-08.jpg" className="d-block w-100" alt="..." />
                                </div>
                                <div className="carousel-item">
                                    <img src="./img/slider/bn-07.jpg" className="d-block w-100" alt="..." />
                                </div>
                                <div className="carousel-item">
                                    <img src="./img/slider/bn-06.jpg" className="d-block w-100" alt="..." />
                                </div><div className="carousel-item">
                                    <img src="./img/slider/bn-05.jpg" className="d-block w-100" alt="..." />
                                </div>
                                <div className="carousel-item">
                                    <img src="./img/slider/bn-04.jpg" className="d-block w-100" alt="..." />
                                </div>
                                <div className="carousel-item">
                                    <img src="./img/slider/bn-03.jpg" className="d-block w-100" alt="..." />
                                </div>
                            </div>
